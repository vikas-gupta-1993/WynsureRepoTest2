...
@%wyde-root%\bin\eWAM.exe "/RUN:aWFReportRequestProcessLauncher.RunReportInAsynchronousProcessWithParam(WynsureSolution_Fr,Report,,%1,%2)" /MULTISESSION:TRUE /runcontextname:prevoyance %*