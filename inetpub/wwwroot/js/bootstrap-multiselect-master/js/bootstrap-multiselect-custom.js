    ...
    Multiselect.prototype = {
        ...
        defaults : {
            ...
            buttonText : function(options, select) {
                ...
                if (options.length == 0) {
                    return '<span class="labelSelect"></span>'+caret;
                }
                else
                if (options.length > 3) {
                    return '<span class="labelSelect">' + options.length + ' selected</span>'+caret;
                }
                else {
                    var selected = '<span class="labelSelect">';
        ...
        createOptionValue : function(element) {
            ...
            var $li = $('<li><a href="javascript:void(0);"><label><span class="input-wrapper"><input type="' + inputType + '" /></span></label></a></li>');
