...
#sys.argv = ["D:\\Wynsure59-1\\Wynsure\\Python\\Pasrau\\Pasrauu.py","D:\\Wynsure59-1\\Wynsure\\batch\\Out_Python\\","D:\\Wynsure59-1\\Wynsure\\batch\\Out_Python\\Out_Pasrau\\"]
...
class Bloc:
    ...
    def append_contact_declare(self, mapping):
        ...
        email = email.replace("_","")
        contact.append_rubrique_from_path('001', 'Nom et prénom du contact', mapping, "getClaimTaxDeductionFlowConfig/getContactName_PASRAUDeclaration")
    ...
    def append_entreprise(self, mapping):
        ...
        entreprise.append_rubrique_from_path('004', "Numéro, extension, nature et libellé de la voie", mapping,
                                           le_path + 'getDefaultAddress/line1')
        ...
        if IsBelongToFrance(country_code):
            ...
            entreprise.append_rubrique_from_path('011', "Code de distribution à l'étranger ", mapping,
                                               le_path + 'getDefaultAddress/zipCode/zipCode')
    ...
    def append_etablissement(self, mapping):
        ...
        etablissement.append_rubrique_from_path('003', 'Numéro, extension, nature et libellé de la voie', mapping, le_path +'getDefaultAddress/line1')
        if IsBelongToFrance(country_code):
            ...
            etablissement.append_rubrique_from_path('016', "Code de distribution à l'étranger ", mapping,
                                               le_path + 'getDefaultAddress/zipCode/zipCode')
    ...
    def append_versement_organisme(self, mapping):
        ...
        Declaration_last_day = str(calendar.monthrange(DeclarationYear, Months[DeclarationMonth])[-1]) + '0'+ str(Months[DeclarationMonth]) + str(DeclarationYear)
    ...
    def append_individu(self, mapping):
        ...
        individu.append_rubrique_from_path('008', 'Numéro, extension, nature et libellé de la voie', mapping,
                                                Idividu_Addr_path + 'line1')
        if IsBelongToFrance(country_code):
            individu.append_rubrique_from_path('009', 'Code postal ', mapping,
                                                    Idividu_Addr_path + 'zipCode/zipCode')
            individu.append_rubrique_from_path('010', 'Localité ', mapping,
                                                    Idividu_Addr_path + 'zipCode/city')
        else:
...
def create_pasrau_file_from_mapping(file,jsonfile):
    ...
    with open(of, 'w',encoding="ISO 8859-1") as f:
        root.write(f)
    subprocess.call(['D:\\Wynsure59-1\\Wynsure\\Python\\Pasrau\\fr.cnav.norme.neorau.val.product-win32.win32.x86_64\\Validation_pasrau.bat',of],stdout=sys.stdout)
...
#os.system('D:\\Wynsure59-1\\Wynsure\\Python\\Pasrau\\fr.cnav.norme.neorau.val.product-win32.win32.x86_64\\Pasrauvalidationbatch.bat r')
